...
function DataKandidat(props) {
    ...
    const deleteKandidat = (id) => {
        axios.delete(`http://localhost:4000/kandidats/${id}`).then(
            res => {
    ...
    const saveData = () => {
        ...
        axios.post(`http://localhost:4000/kandidats`, data).then(
            res => {
    ...
    const deleteFoto = (foto) => {
        axios.delete(`http://localhost:4000/delete/${foto}`).then(
            res => {
    ...
    const searchUsername = (nama) => {
        axios.get(`http://localhost:4000/search?nama=${nama}`).then(
            res => {
