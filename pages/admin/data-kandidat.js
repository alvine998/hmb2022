...
function DataKandidat(props) {
    ...
    const getDataKandidatOne = (id) => {
        axios.get(`http://apievotinghmb.tutorialbyalvine.com/kandidats/${id}`).then(
            res => {
    ...
    const deleteKandidat = (id) => {
        axios.delete(`http://apievotinghmb.tutorialbyalvine.com/kandidats/${id}`).then(
            res => {
    ...
    const saveData = () => {
        ...
        axios.post(`http://apievotinghmb.tutorialbyalvine.com/kandidats`, data).then(
            res => {
    ...
    const uploadFoto = () => {
        ...
        axios.post(`http://apievotinghmb.tutorialbyalvine.com/upload`, formdata).then(
            res => {
    ...
    const deleteFoto = (foto) => {
        axios.delete(`http://apievotinghmb.tutorialbyalvine.com/delete/${foto}`).then(
            res => {
    ...
    const searchUsername = (nama) => {
        axios.get(`http://apievotinghmb.tutorialbyalvine.com/search?nama=${nama}`).then(
            res => {
        ...
        return (
            collect.map((res, i) => (
                <tr key={i}>
                    <th scope="row">{i + 1}</th>
                    <td>{res.nama}</td>
                    <td>{<img src={`http://apievotinghmb.tutorialbyalvine.com/resources/uploads/${res.foto}`} className='w-100 h-100' />}</td>
                    <td>{res.visi}</td>
                    <td>{res.misi}</td>
