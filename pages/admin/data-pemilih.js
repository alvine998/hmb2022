...
function DataPemilih(props) {
    ...
    const saveData = () => {
        ...
        axios.post(`http://evotinghmb.herokuapp.com/users`, data).then(
            res => {
    ...
    const deletePemilih = (id) => {
        axios.delete(`http://evotinghmb.herokuapp.com/users/${id}`).then(
            res => {
    ...
    const updatePemilih = (id) => {
        ...
        axios.put(`http://evotinghmb.herokuapp.com/users/${id}`, data).then(
            res => {
    ...
    const getDataPemilihOne = (id) => {
        axios.get(`http://evotinghmb.herokuapp.com/users/${id}`).then(
            res => {
    ...
    const searchUsername = (username) => {
        axios.get(`http://evotinghmb.herokuapp.com/search?username=${username}`).then(
            res => {
